            ...
            <div className="card-body">
                <div className="d-flex justify-content-between">
                    ...
                    <ul class="dropdown-menu" style={{minWidth: "200px"}}>
                        ...
                        <li className="dropdown-item"  style={{cursor: "pointer"}} onClick={() => navigator.clipboard.writeText(currImage?.imageUrl)}><Link2Icon size={20} className="me-2"/>Copy link</li>
